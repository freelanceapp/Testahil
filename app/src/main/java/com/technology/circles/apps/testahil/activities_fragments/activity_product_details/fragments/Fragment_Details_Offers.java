...
import com.creative.share.apps.testahil.databinding.FragmentDetailsOffersBinding;
...
public class Fragment_Details_Offers extends Fragment {
    private static final String TAG ="DATA";
    private FragmentDetailsOffersBinding binding;
    ...
    public static Fragment_Details_Offers newInstance(ProductModel productModel) {

        Bundle bundle = new Bundle();
        bundle.putSerializable(TAG,productModel);
        Fragment_Details_Offers fragment_details_offers = new Fragment_Details_Offers();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_details_offers, container, false);
        initView();
