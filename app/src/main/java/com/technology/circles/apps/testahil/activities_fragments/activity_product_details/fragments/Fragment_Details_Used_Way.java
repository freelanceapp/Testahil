...
import com.creative.share.apps.testahil.databinding.FragmentDetailsUsedWayBinding;
...
public class Fragment_Details_Used_Way extends Fragment {
    private static final String TAG ="DATA";
    private FragmentDetailsUsedWayBinding binding;
    ...
    public static Fragment_Details_Used_Way newInstance(ProductModel productModel) {

        Bundle bundle = new Bundle();
        bundle.putSerializable(TAG,productModel);
        Fragment_Details_Used_Way fragment_details_offers = new Fragment_Details_Used_Way();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_details_used_way, container, false);
        initView();
